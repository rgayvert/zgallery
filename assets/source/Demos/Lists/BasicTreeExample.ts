...
export function BasicTreeExample(): View {
  ...
  const opts: TreeOptions = { height: em(15), width: ch(30), alignItems: "stretch", justifyContent: "start" };
  ...
  return SoftGrid({ justifyItems: "center", minColumnWidth: "40ch", rowGap: core.space.s5 }).append(
    SimpleTree(tree, selection1, (node) => node.data, { ...opts, showRoot: true, initialExpansionLevel: 1 }),
