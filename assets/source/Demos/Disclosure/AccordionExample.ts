...
const accordionData: DemoData[] = zutil.sequence(0, 5).map((i) => ({ id: i, title: lorem.words(4), detail: lorem.sentences(20) }));
...
export function AccordionExample(): View {
  ...
  return HStack({ padding: core.space.s5 }).append(
    SimpleDisclosureList(accordionData, selectedDisclosureItem, (dataItem) => dataItem.title, createDisclosureDetail, {
